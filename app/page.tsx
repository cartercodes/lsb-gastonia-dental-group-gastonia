...
export default function HomePage() {
  ...
  const trustItems = [
    { text: 'Trusted by 500+ Gastonia Families', icon: trustIcons[0] },
    { text: 'Over 15 Years Serving Gaston County', icon: trustIcons[1] },
    { text: 'Top-Rated on Google With 200+ Five-Star Reviews', icon: trustIcons[2] },
    { text: 'Same-Day Emergency Appointments Available', icon: trustIcons[3] },
  ];

  const services = [
    { title: 'General & Family Dentistry', desc: 'From first teeth to golden years, Gastonia Dental Group provides comprehensive care for every member of your family. Routine cleanings, exams, and preventive treatments tailored to keep Gastonia smiles healthy for life.', icon: serviceIcons[0] },
    { title: 'Cosmetic Dentistry', desc: 'Veneers, whitening, and smile makeovers designed right here in Gastonia. Walk out of our office with the kind of confidence that changes how you carry yourself.', icon: serviceIcons[1] },
    { title: 'Dental Implants', desc: 'Missing teeth deserve a permanent solution. Our implant specialists restore your smile with results that look, feel, and function like natural teeth.', icon: serviceIcons[2] },
    { title: 'Emergency Dental Care', desc: 'Toothaches and broken teeth don\'t wait for business hours. Gastonia Dental Group offers same-day emergency appointments so you\'re never left in pain.', icon: serviceIcons[3] },
    { title: 'Invisalign & Orthodontics', desc: 'Straighter teeth without the metal. We\'ve helped hundreds of Gastonia adults and teens transform their smiles with clear aligner therapy.', icon: serviceIcons[4] },
    { title: 'Pediatric Dentistry', desc: 'A positive first experience at the dentist sets the tone for a lifetime of healthy habits. We make every visit fun, gentle, and stress-free for Gastonia\'s youngest patients.', icon: serviceIcons[5] },
  ];
  ...
  return (
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-logo">{'Gastonia Dental Group'}</div>
        <a
          href="tel:17048000303"
          className="nav-cta"
          aria-label="Call Gastonia Dental Group at +1 704-800-0303"
        >
          <span
            dangerouslySetInnerHTML={{ __html: phoneIcon }}
            aria-hidden="true"
          />
          <span>{'+1 704-800-0303'}</span>
        </a>
      </nav>

      {/* HERO */}
      <section className="hero" aria-label="Welcome to Gastonia Dental Group">
        ...
        <div className="hero-content">
          <span className="hero-badge">Trusted Dental Care in {'Gastonia'}</span>
          <h1>Your Smile Deserves Gentle, Expert Dentistry</h1>
          <p>
            Welcome to {'Gastonia Dental Group'} — where modern dental technology meets compassionate
      ...
      <section className="about" aria-label="About our practice">
        <div className="about-grid">
          <div className="about-image" data-animate>
            <img
              src="https://images.unsplash.com/photo-1581291518857-4d27a0b7e7b4?auto=format&fit=crop&w=1400&q=80"
              alt=""
              loading="lazy"
              style={{
                width: '100%',
          ...
          <div className="about-content" data-animate data-delay={2}>
            <h2>About {'Gastonia Dental Group'}</h2>
            <p>{'Gastonia Dental Group was built on a simple belief: everyone in Gastonia deserves a dentist who treats them like a neighbor, not a number. From our roots in Gaston County, we\'ve grown into one of the area\'s most trusted practices by combining advanced technology with the kind of genuine, unhurried care that big corporate offices just can\'t replicate. Whether you\'re here for a routine cleaning or a complete smile transformation, you\'ll feel the difference the moment you walk through our doors.'}</p>
      ...
      <section className="cta-section" aria-label="Contact us">
        <div className="cta-card" data-animate>
          <h2>Contact {'Gastonia Dental Group'}</h2>
          <p>
          ...
          <a
            ...
            aria-label="Call Gastonia Dental Group to schedule an appointment"
          >
            <span
              dangerouslySetInnerHTML={{ __html: phoneIcon }}
              aria-hidden="true"
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-brand-name">{'Gastonia Dental Group'}</div>
            <p>
              Providing quality dental care for families in {'Gastonia'},{' '}
          ...
          <div className="footer-contact">
            <div className="footer-contact-item">
              ...
              />
              <span>
                {'2205 E Franklin Blvd #110, Gastonia, NC 28054, USA'}, {'Gastonia'}, {'NC'}
              </span>
            </div>
            <div className="footer-contact-item">
              <span
              ...
              <a
                href="tel:17048000303"
                aria-label="Call Gastonia Dental Group"
        ...
        <div className="footer-bottom">
          &copy; {new Date().getFullYear()} {'Gastonia Dental Group'}. All rights
          reserved.
        </div>
      </footer>
    </>
